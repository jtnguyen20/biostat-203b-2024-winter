...
```
In general, there is a larger share of young adult patients compared to adult and elderly patients, for both genders. This observation is surprising, as we would assume the opposite with more elderly patients and less young adult patients. However, the oldest elderly patients seem to make up a sizable share of the total patients, likely due to worsening health conditions. Across all ages, there is a larger share of female patients compared to male patients, and this difference is especially prominent for the youngest and oldest age groups. This could be due to multiple factors, e.g. women may be more likely to seek out medical care or come in more often for female-specific health conditions. 
...
labevents_icustays <- left_join(icustays_subset, labevents_subset, 
                                by = "subject_id") 
head(labevents_icustays, n=10)
```
