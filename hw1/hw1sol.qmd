...
who am i
```
The `who am i` command shows who is on my Mac. It displays my log-in name and today's date and current time. 

```{bash}
who
```
The `who` command shows also shows who is on my Mac, with slightly different information. It displays my log-in name 
